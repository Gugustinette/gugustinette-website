...
Last 40 years were crazy for the video game industry. So much changed about what games are, where we play them, how we play them and of course… How they’re made ! Let's talk about the state of game development and what it could be in the future.
...
Recently, technologies such as [Nuxt](https://nuxt.com/) or [Next](https://nextjs.org/) along with services like [Vercel](https://vercel.com) or [Coolify](https://coolify.io/) are pushing the web developer experience in its limits.
...
Here's an very good example of people complaining about Unity UI system : [r/gamedev/i_hate_making_ui](https://www.reddit.com/r/gamedev/comments/1ari3p0/i_hate_making_ui).

But guess what ? The entire JavaScript ecosystem spent the last 10 years fighting to make the best UI libraries, so you can create beautiful, complexe and reactive UIs in a few lines of code. And it’s all open-source !
...
- Atleast acceptable performances
